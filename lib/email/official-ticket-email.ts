...
export function buildOfficialTicketEmail(input: OfficialTicketEmailInput, logoSrc: string | null = CMMS_EMAIL_LOGO_SRC): ReservedSeatEmailContent {
  ...
  const text = [
    ...
    "",
    codeSection.text,
    `View Ticket: ${input.viewTicketUrl}`,
