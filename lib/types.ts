...
export type SponsorLibraryEntry = {
  ...
  preferred_contact_method?: "email" | "phone" | "text" | "none";
  ...
  standard_sponsorship_amount?: number | null;
  is_in_kind?: boolean;
  in_kind_description?: string | null;
  sponsor_since_year?: number | null;
...
export type ShowCompTicket = {
  ...
  door_payment_method?: "cash" | "card" | null;
...
export type SponsorLibraryFormState = {
  ...
  sponsorSinceYear: string;
  contactPerson: string;
  contactTitle: string;
  email: string;
  phone: string;
  mobilePhone: string;
  preferredContactMethod: "email" | "phone" | "text" | "none";
  ...
  facebookUrl: string;
  instagramUrl: string;
  standardSponsorshipAmount: string;
  isInKind: boolean;
