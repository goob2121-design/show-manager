...
test("existing Logout clears browser markers, awaits server logout, then redirects to the root landing page", () => {
  ...
  assert.match(quickNav, /window\.location\.href = "\/";/);
  assert.doesNotMatch(quickNav, /window\.location\.href = currentView/);
});
