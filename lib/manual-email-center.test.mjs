...
test("Email Center templates provide editable starter content and blank Custom fields", () => {
  ...
  assert.match(presale?.message ?? "", /Gmail users: If you don't see our email in your Primary inbox, please check Promotions\. You may also want to check Spam or Social\./);
