...
export const manualEmailTemplates = [
  ...
  },
  {
    ...
    subject: "CMMS Early Access Presale",
    ...
    message: [
      "Hi {{first_name}},",
      "",
      "As a CMMS Mailing List subscriber, you're getting early access to tickets for {{show_name}} on {{show_date}} before they go on sale to the general public.",
      "",
