create or replace function public.undo_sponsor_comp_redemption_token(
  p_show_id uuid,
  p_show_slug text,
  p_token_id uuid,
...
begin
  ...
  update public.show_sponsors as sponsor_row
  set comp_tickets_checked_in = sponsor_row.comp_tickets_checked_in - 1
  where sponsor_row.id = v_sponsor.id
    and sponsor_row.show_id = p_show_id;

  update public.show_sponsor_comp_redemption_tokens as token_row
